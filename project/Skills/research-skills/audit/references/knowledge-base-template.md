...
*Phase 1 — advisory-hunter. Full machine-readable inventory in `piolium/attack-surface/sbom.json`.*
...
*Phase 3 — knowledge-base-builder. Curated security-relevant subset of the Component Inventory above (seeded from `sbom.json`).*
