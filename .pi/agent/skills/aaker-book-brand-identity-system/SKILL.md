---
name: aaker-book-brand-identity-system
description: |
  Use when: Design core identity, extended identity, brand essence. Trigger phrases: "brand identity system", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Kodak, with its block letters and bright yellow background, has been used for over a hundred years to crystallize and communicate the essence of Eastman’s products and organization."
>
> — Source: BSB Ch3

**Source mechanism:** Design core identity, extended identity, brand essence This skill encodes the method from BSB Ch3 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Design core identity, extended identity, brand essence The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BSB Ch3.
...
1. Design core identity, extended identity, brand essence
...
- "how to design core identity, extended identity, brand essence"
...
- **Method applied:** `aaker-book-brand-identity-system`
...
- The problem is outside the scope of BSB Ch3.
