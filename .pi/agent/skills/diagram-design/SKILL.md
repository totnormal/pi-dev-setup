...
name: diagram-design
description: "Diagram Design. Create visual diagrams as self-contained HTML files with inline SVG and CSS, following an opinionated editorial design system. Keywords: diagram design."
license: MIT
metadata:
  version: "1.0"
---
