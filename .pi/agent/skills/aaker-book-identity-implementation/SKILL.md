---
name: aaker-book-identity-implementation
description: |
  Use when: Translate identity into programs, symbols, and communication. Trigger phrases: "identity implementation", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Identity Implementation The Brand Position Achieving Brilliance in Execution Tracking A Strategic Brand Analysis The Power of Brand Identity and Position 7."
>
> — Source: BSB Ch6

**Source mechanism:** Translate identity into programs, symbols, and communication This skill encodes the method from BSB Ch6 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Translate identity into programs, symbols, and communication The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BSB Ch6.
...
1. Translate identity into programs, symbols, and communication
...
- "how to translate identity into programs, symbols, and communication"
...
- **Method applied:** `aaker-book-identity-implementation`
...
- The problem is outside the scope of BSB Ch6.
