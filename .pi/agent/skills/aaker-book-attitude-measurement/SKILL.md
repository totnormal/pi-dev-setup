---
name: aaker-book-attitude-measurement
description: |
  Use when: Measure attitudes via multi-item scales. Trigger phrases: "attitude measurement", "brand research", Aaker research. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "The survey and scanner data techniques have empowered companies to collect a wide range of customer information pertaining to attitudes, behaviors, and demographics."
>
> — Source: MR Ch11

**Source mechanism:** Measure attitudes via multi-item scales This skill encodes the method from MR Ch11 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Measure attitudes via multi-item scales The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MR Ch11.
...
1. Measure attitudes via multi-item scales
...
- "how to measure attitudes via multi-item scales"
...
- **Method applied:** `aaker-book-attitude-measurement`
...
- The problem is outside the scope of MR Ch11.
