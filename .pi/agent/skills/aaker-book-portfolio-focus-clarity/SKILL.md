---
name: aaker-book-portfolio-focus-clarity
description: |
  Use when: Audit and rationalize the portfolio toward focus. Trigger phrases: "portfolio focus clarity", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Portfolio Focus Clarity

## R — Reading

> "TOWARD FOCUS AND CLARITY UNILEVER FORD VS."
>
> — Source: BPS Ch10

**Source mechanism:** Audit and rationalize the portfolio toward focus This skill encodes the method from BPS Ch10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Audit and rationalize the portfolio toward focus The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BPS Ch10.
...
1. Audit and rationalize the portfolio toward focus
...
- "how to audit and rationalize the portfolio toward focus"
...
- **Method applied:** `aaker-book-portfolio-focus-clarity`
...
- The problem is outside the scope of BPS Ch10.
