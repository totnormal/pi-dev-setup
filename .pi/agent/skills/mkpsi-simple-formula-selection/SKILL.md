---
name: mkpsi-simple-formula-selection
description: |
  Use when: “Culture fit,” “overall impression,” “expert judgment,” “I liked the interview,” choose ca
  ndidate/vendor. Trigger phrases: I liked the interview,, culture fit,, overall impression,, choose c
  andidate/vendor,, expert judgment,, rubric.. NOT for: Use in low-validity or noisy selection context
  s. Do not ignore legally/ethically required constraints; monitor for biased predictors.
source_book: |
...
source_chapter: |
  Ch. 21 “Intuitions vs. Formulas,” “Learning from Meehl,” “Do It Yourself”
tags: [mkpsi-v2, general, p1]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-decorrelate-judgment, mkpsi-demeanor-signal-downgrade, mkpsi-expert-intuition-validity-test]
disable-model-invocation: true
---

# Replace noisy holistic selection with a simple scored formula.

## R — Reading

> “First, select a few traits that are prerequisites for success in this position... Next, make a list of those questions for each trait and think about how you will score it, say on a 1–5 scale.”
>
> — Source: Ch. 21 “Intuitions vs. Formulas,” “Learning from Meehl,” “Do It Yourself”

**Source mechanism:** For selection decisions, choose ~6 independent predictors, define factual questions and 1–5 scoring rules, score each predictor separately, sum scores, and precommit to highest score absent a decisive broken-leg exception.
...
For selection decisions, choose ~6 independent predictors, define factual questions and 1–5 scoring rules, score each predictor separately, sum scores, and precommit to highest score absent a decisive broken-leg exception.
...
### Case 1: Meehl review
- **Problem:** Meehl review: statistical formulas beat or matched clinicians across parole, grades, pilot training, recidivism, medical and business outcomes.
...
### Case 2: Israeli army interview
- **Problem:** Israeli army interview: six separately scored traits plus formula improved prediction; “close your eyes” intuition added value only after structured data collection.
...
1. “Culture fit,” “overall impression,” “expert judgment,” “I liked the interview,” choose candidate/vendor.
...
- Sibling confusion risks: Not merely a checklist; it is a predictive scoring formula. Not a machine-learning requirement; equal weights often suffice.

---

## E — Execution steps

1. **Apply the source method: For selection decisions, choose ~6 independent predictors, define factual questions and 1–5 scoring rules, score each predictor separately, sum scores, and precommit to highest score absent a decisive broken-leg exception.**
...
- **Selected mechanism:** `mkpsi-simple-formula-selection` — Replace noisy holistic selection with a simple scored formula.
...
- Use in low-validity or noisy selection contexts. Do not ignore legally/ethically required constraints; monitor for biased predictors.
...
Not merely a checklist; it is a predictive scoring formula. Not a machine-learning requirement; equal weights often suffice.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-decorrelate-judgment, /mkpsi-demeanor-signal-downgrade, /mkpsi-expert-intuition-validity-test
