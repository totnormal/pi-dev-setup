---
name: aaker-book-media-tactics-allocation
description: |
  Use when: Allocate media budgets across channels and timing. Trigger phrases: "media tactics allocation", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Media Tactics Allocation

## R — Reading

> "Media tactics refers to the allocation of advertising budgets across specific media vehicles. Should we advertise in Cosmopolitan or Vogue, or both? Should a two-page advertisement be used or would a single-page be better?"
>
> — Source: AM Ch17

**Source mechanism:** Allocate media budgets across channels and timing This skill encodes the method from AM Ch17 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Allocate media budgets across channels and timing The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch17.
...
1. Allocate media budgets across channels and timing
...
- "how to allocate media budgets across channels and timing"
...
- **Method applied:** `aaker-book-media-tactics-allocation`
...
- The problem is outside the scope of AM Ch17.
