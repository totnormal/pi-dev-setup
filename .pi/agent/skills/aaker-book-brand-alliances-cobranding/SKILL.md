---
name: aaker-book-brand-alliances-cobranding
description: |
  Use when: Form brand alliances and co-branding partnerships. Trigger phrases: "brand alliances cobranding", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
  Brand Leadership (2000) + Brand Portfolio Strategy (2004) — David A. Aaker
source_chapter: |
  BPS Ch6
tags: [aaker-books, architecture, p1]
related_skills: [aaker-book-architecture-orchestrator, aaker-book-architecture-verifier, aaker-book-orchestrator, aaker-book-output-verifier]
disable-model-invocation: true
---

# Brand Alliances Cobranding

## R — Reading

> "ACCESSING STRATEGIC ASSETS: BRAND ALLIANCES FORD EXPLORER EDDIE BAUER EDITION CO—MASTER BRANDED OFFERINGS EXTERNAL BRANDED DIFFERENTIATORS EXTERNAL BRANDED ENERGIZERS TACTICAL BRAND ALLIANCES DEVELOPING EFFECTIVE BRAND ALLIANCES PART III."
>
> — Source: BPS Ch6

**Source mechanism:** Form brand alliances and co-branding partnerships This skill encodes the method from BPS Ch6 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Form brand alliances and co-branding partnerships The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Applied across multiple cases in Brand Leadership (2000) + Brand Portfolio Strategy (2004) — David A. Aaker.
...
- **Result/evidence:** Corroborating case from BPS Ch6.
...
1. Form brand alliances and co-branding partnerships
...
- "how to form brand alliances and co-branding partnerships"

### Distinction from siblings
- Use `/aaker-book-orchestrator` when unsure which Aaker skill applies.
- Use `aaker-book-architecture-verifier` to QA the output of this skill.
- See the set INDEX for sibling skills within Set 2: Brand Architecture & Portfolio.
...
- **Method applied:** `aaker-book-brand-alliances-cobranding`
...
- The problem is outside the scope of BPS Ch6.
...
- composes-with: `/aaker-book-architecture-orchestrator`, `/aaker-book-architecture-verifier`, `/aaker-book-orchestrator`
