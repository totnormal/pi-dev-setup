---
name: mkpsi-reference-class-forecast
description: |
  Use when: Roadmap, project, budget, launch, campaign, or “we’re different” forecast. Trigger phrases
  : timeline,, budget,, roadmap,, we’re different,, best case,, unknown unknowns,. NOT for: Reference 
  class choice is decisive; report uncertainty and alternatives. Do not use stale or non-comparable da
  tasets without caveat.
source_book: |
...
source_chapter: |
  Ch. 23 “The Outside View,” “Mitigating the Planning Fallacy”
tags: [mkpsi-v2, bias, p1]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-premortem-plan-debias, mkpsi-test-learn-adapt-rct]
disable-model-invocation: true
---

# Take the outside view with reference class forecasting.

## R — Reading

> “Identify an appropriate reference class... Obtain the statistics of the reference class... Use specific information about the case to adjust the baseline prediction.”
>
> — Source: Ch. 23 “The Outside View,” “Mitigating the Planning Fallacy”

**Source mechanism:** For project forecasts, ignore the plan briefly; identify comparable projects, collect completion/cost/success statistics, set baseline, then adjust only for documented differences.
...
For project forecasts, ignore the plan briefly; identify comparable projects, collect completion/cost/success statistics, set baseline, then adjust only for documented differences.
...
### Case 1: Curriculum project
- **Problem:** Curriculum project: inside estimates were ~2 years; comparable teams suggested 40% failure and 7–10 years; actual completion took 8 years.
...
### Case 2: Scottish Parliament/rail/kitchen projects
- **Problem:** Scottish Parliament/rail/kitchen projects: budgets and usage forecasts showed large overruns and optimism.
...
1. Roadmap, project, budget, launch, campaign, or “we’re different” forecast.
...
- Sibling confusion risks: Similar to base-rate discipline but focused on project plans, timelines, costs, benefits, and completion risk.

---

## E — Execution steps

1. **Apply the source method: For project forecasts, ignore the plan briefly; identify comparable projects, collect completion/cost/success statistics, set baseline, then adjust only for documented differences.**
...
- **Selected mechanism:** `mkpsi-reference-class-forecast` — Take the outside view with reference class forecasting.
...
- Reference class choice is decisive; report uncertainty and alternatives. Do not use stale or non-comparable datasets without caveat.
...
Similar to base-rate discipline but focused on project plans, timelines, costs, benefits, and completion risk.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-premortem-plan-debias, /mkpsi-test-learn-adapt-rct
