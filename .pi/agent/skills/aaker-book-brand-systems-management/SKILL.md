---
name: aaker-book-brand-systems-management
description: |
  Use when: Manage range brands, subbrands, driver/endorsed roles. Trigger phrases: "brand systems management", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Brands that offer something better include Norelco, which provides the closest shave via its lift-and-cut system; the 7-Eleven chain, which offers more convenience than grocery stores; the Marriott chain, with its express checkout; and McDonald’s, with its unrivaled worldwide pro"
>
> — Source: BSB Ch8

**Source mechanism:** Manage range brands, subbrands, driver/endorsed roles This skill encodes the method from BSB Ch8 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Manage range brands, subbrands, driver/endorsed roles The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BSB Ch8.
...
1. Manage range brands, subbrands, driver/endorsed roles
...
- "how to manage range brands, subbrands, driver/endorsed roles"
...
- **Method applied:** `aaker-book-brand-systems-management`
...
- The problem is outside the scope of BSB Ch8.
