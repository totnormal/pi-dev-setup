---
name: aaker-book-business-energizing
description: |
  Use when: Energize a business via new value propositions, categories. Trigger phrases: "business energizing", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Spotify — Identifying a New Value Proposition 120 Case 3 — Competing Against Industry Giants."
>
> — Source: SMM Ch10

**Source mechanism:** Energize a business via new value propositions, categories This skill encodes the method from SMM Ch10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Energize a business via new value propositions, categories The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch10.
...
1. Energize a business via new value propositions, categories
...
- "how to energize a business via new value propositions, categories"
...
- **Method applied:** `aaker-book-business-energizing`
...
- The problem is outside the scope of SMM Ch10.
