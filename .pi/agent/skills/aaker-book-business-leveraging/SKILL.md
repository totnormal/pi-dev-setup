---
name: aaker-book-business-leveraging
description: |
  Use when: Leverage a business via brand extensions, cobranding, channels. Trigger phrases: "business leveraging", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Leveraging the Business 213 Which Assets and Competences Can Be Leveraged?"
>
> — Source: SMM Ch11

**Source mechanism:** Leverage a business via brand extensions, cobranding, channels This skill encodes the method from SMM Ch11 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Leverage a business via brand extensions, cobranding, channels The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch11.
...
1. Leverage a business via brand extensions, cobranding, channels
...
- "how to leverage a business via brand extensions, cobranding, channels"
...
- **Method applied:** `aaker-book-business-leveraging`
...
- The problem is outside the scope of SMM Ch11.
