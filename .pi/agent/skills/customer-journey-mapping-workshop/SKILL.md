...
## Cross-Reference
Use the templates and stage definitions from `skills/customer-journey-map` when turning the workshop output into a durable artifact.

## Sources
- Base: `monichre__product-manager-skills__customer-journey-mapping-workshop.md`
- Merged: `eddiebe147__claude-settings__customer-journey-mapper.md`
