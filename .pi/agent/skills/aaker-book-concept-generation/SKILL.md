---
name: aaker-book-concept-generation
description: |
  Use when: Generate new product/category concepts systematically. Trigger phrases: "concept generation", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
**Source mechanism:** Generate new product/category concepts systematically This skill encodes the method from BR Ch6 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Generate new product/category concepts systematically The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BR Ch6.
...
1. Generate new product/category concepts systematically
...
- "how to generate new product/category concepts systematically"
...
- **Method applied:** `aaker-book-concept-generation`
...
- The problem is outside the scope of BR Ch6.
