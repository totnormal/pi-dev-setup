---
name: aaker-book-brand-loyalty-management
description: |
  Use when: Reduce switching, build loyalty programs, measure switching cost. Trigger phrases: "brand loyalty management", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Brand Loyalty ¹ The MicroPro story was drawn in part from a variety of published sources including Cheryl Spencer, “The Rebirth of a Classic,” Personal Computing, February 1987, pp."
>
> — Source: MBE Ch2

**Source mechanism:** Reduce switching, build loyalty programs, measure switching cost This skill encodes the method from MBE Ch2 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Reduce switching, build loyalty programs, measure switching cost The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch2.
...
1. Reduce switching, build loyalty programs, measure switching cost
...
- "how to reduce switching, build loyalty programs, measure switching cost"
...
- **Method applied:** `aaker-book-brand-loyalty-management`
...
- The problem is outside the scope of MBE Ch2.
