---
name: aaker-book-competitive-barriers
description: |
  Use when: Create barriers to competition (scale, must-haves, brand linkage). Trigger phrases: "competitive barriers", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Brand relevance that yields sustainable differentiation resulting in new categories or subcategories of products or services where competitors are less or even non-relevant."
>
> — Source: BR Ch9

**Source mechanism:** Create barriers to competition (scale, must-haves, brand linkage) This skill encodes the method from BR Ch9 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Create barriers to competition (scale, must-haves, brand linkage) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BR Ch9.
...
1. Create barriers to competition (scale, must-haves, brand linkage)
...
- "how to create barriers to competition (scale, must-haves, brand linkage)"
...
- **Method applied:** `aaker-book-competitive-barriers`
...
- The problem is outside the scope of BR Ch9.
