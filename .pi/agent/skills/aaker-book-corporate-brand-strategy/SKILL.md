---
name: aaker-book-corporate-brand-strategy
description: |
  Use when: Leverage the corporate brand across offerings. Trigger phrases: "corporate brand strategy", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "THE BRAND RELATIONSHIP SPECTRUM THE DISNEY BRAND FAMILY MASTER BRANDS , ENDORSERS , SUBBRANDS , AND DRIVER ROLES LINKING BRANDS—THE BRAND RELATIONSHIP SPECTRUM A HOUSE OF BRANDS ENDORSED BRANDS SUBBRANDS A BRANDED HOUSE SELECTING THE RIGHT POSITION IN THE BRAND RELATIONSHIP SPECT"
>
> — Source: BPS Ch9

**Source mechanism:** Leverage the corporate brand across offerings This skill encodes the method from BPS Ch9 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Leverage the corporate brand across offerings The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BPS Ch9.
...
1. Leverage the corporate brand across offerings
...
- "how to leverage the corporate brand across offerings"
...
- **Method applied:** `aaker-book-corporate-brand-strategy`
...
- The problem is outside the scope of BPS Ch9.
