---
name: mkpsi-timely-precommitment-before-temptation
description: |
  Use when: People want future-beneficial action but reverse when cash, fatigue, hunger, temptation, o
  r immediate costs dominate. Trigger phrases: future self, ask before they receive cash, write down w
  hen, commitment device, they intend to but forget.. NOT for: Commitments must be voluntary, reversib
  le when appropriate, and not exploit moments of grief, illness, or confusion. Avoid excessive penalt
  ies.
source_book: |
...
source_chapter: |
  Chapter 6, “Timely”; “Choosing for our future selves”; wills, charity, flu jabs, implementation inte
  ntions.
tags: [mkpsi-v2, choice, p1]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-key-moment-disruption-window, mkpsi-active-commitment-and-plan]
disable-model-invocation: true
---

# Ask before money, temptation, or hot-state pressure arrives.

## R — Reading

> “Encouraging people to think not just about what they want to do, but when and how, makes them much more likely to see through their own intentions.”
>
> — Source: Chapter 6, “Timely”; “Choosing for our future selves”; wills, charity, flu jabs, implementation intentions.

**Source mechanism:** - **Recognize:** People want a future-beneficial action but reverse when cash, hunger, fatigue, or temptation is present.
- **Intervene:** Ask for commitment, plan, date/time, allocation, or self-binding before the hot state; place prompt at the natural decision point.
- **Assess:** Measure follow-through, opt-out, later regret, and commitment satisfaction.
...
- **Recognize:** People want a future-beneficial action but reverse when cash, hunger, fatigue, or temptation is present.
- **Intervene:** Ask for commitment, plan, date/time, allocation, or self-binding before the hot state; place prompt at the natural decision point.
- **Assess:** Measure follow-through, opt-out, later regret, and commitment satisfaction.
...
### Case 1: 1. Will-writing scripts
- **Problem:** 1. Will-writing scripts: asking about charitable bequests at the will-writing moment doubled giving; empathetic/social wording trebled it and increased average bequest.
...
### Case 2: 2. Flu-jab letters with boxes for date and time increased vaccination by prompti
- **Problem:** 2. Flu-jab letters with boxes for date and time increased vaccination by prompting implementation intentions.
...
1. People want future-beneficial action but reverse when cash, fatigue, hunger, temptation, or immediate costs dominate.
...
- Sibling confusion risks: - Not `mkpsi-key-moment-disruption-window`: this focuses on precommitment against time inconsistency.
- Not `mkpsi-add-good-friction`: commitment may bind future choices, but not by adding generic friction.

---

## E — Execution steps

1. **Apply the source method: - **Recognize:** People want a future-beneficial action but reverse when cash, hunger, fatigue, or temptation is present. - **Intervene:** Ask for commitment, plan, date/time, allocation, or self-binding before the hot state; place prompt at the natural decision point. - **Assess:** Measure follow-through, opt-out, later regret, and commitment satisfaction.**
...
- **Selected mechanism:** `mkpsi-timely-precommitment-before-temptation` — Ask before money, temptation, or hot-state pressure arrives.
...
- Commitments must be voluntary, reversible when appropriate, and not exploit moments of grief, illness, or confusion. Avoid excessive penalties.
...
- Not `mkpsi-key-moment-disruption-window`: this focuses on precommitment against time inconsistency.
- Not `mkpsi-add-good-friction`: commitment may bind future choices, but not by adding generic friction.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-key-moment-disruption-window, /mkpsi-active-commitment-and-plan
