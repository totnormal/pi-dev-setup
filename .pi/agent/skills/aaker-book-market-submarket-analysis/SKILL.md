---
name: aaker-book-market-submarket-analysis
description: |
  Use when: Analyze market structure, size, growth, dynamics. Trigger phrases: "market submarket analysis", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Market/Submarket Analysis 60 Dimensions of a Market/Submarket Analysis 61 Emerging Submarkets 61 Actual and Potential Market or Submarket Size 62 Market and Submarket Growth 65 Market and Submarket Profitability Analysis 68 Cost Structure 70 Distribution Systems 71 Market Trends"
>
> — Source: SMM Ch4

**Source mechanism:** Analyze market structure, size, growth, dynamics This skill encodes the method from SMM Ch4 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Analyze market structure, size, growth, dynamics The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch4.
...
1. Analyze market structure, size, growth, dynamics
...
- "how to analyze market structure, size, growth, dynamics"
...
- **Method applied:** `aaker-book-market-submarket-analysis`
...
- The problem is outside the scope of SMM Ch4.
