---
name: aaker-book-brand-association-positioning
description: |
  Use when: Select and create brand associations, make the positioning decision. Trigger phrases: "brand association positioning", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Brand Associations: The Positioning Decision ¹ The Weight Watchers story is drawn in part from Rebecca Fannin, “Shape Up,” Marketing & Media Decisions, February 1986, pp."
>
> — Source: MBE Ch5, MBE Ch7

**Source mechanism:** Select and create brand associations, make the positioning decision This skill encodes the method from MBE Ch5, BSB Ch3 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Select and create brand associations, make the positioning decision The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch5, BSB Ch3.
...
1. Select and create brand associations, make the positioning decision
...
- "how to select and create brand associations, make the positioning decision"
...
- **Method applied:** `aaker-book-brand-association-positioning`
...
- The problem is outside the scope of MBE Ch5, BSB Ch3.
