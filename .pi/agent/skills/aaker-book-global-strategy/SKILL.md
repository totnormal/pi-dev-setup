---
name: aaker-book-global-strategy
description: |
  Use when: Develop global strategy adapted to local markets. Trigger phrases: "global strategy", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Aaker Damien McLoughlin “~ dnagement Global Perspectives WILEY STRATEGIC MARKET MANAGEMENT ‘The truisni that business is becoming more global is perceived as'ati opportunity for many business leaders, but'as’a painful reality for others."
>
> — Source: SMM Ch13

**Source mechanism:** Develop global strategy adapted to local markets This skill encodes the method from SMM Ch13 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Develop global strategy adapted to local markets The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch13.
...
1. Develop global strategy adapted to local markets
...
- "how to develop global strategy adapted to local markets"
...
- **Method applied:** `aaker-book-global-strategy`
...
- The problem is outside the scope of SMM Ch13.
