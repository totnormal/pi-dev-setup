---
name: aaker-book-brand-equity-ten-measurement
description: |
  Use when: Apply the 10-category equity tracking system. Trigger phrases: "brand equity ten measurement", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Brand Equity Ten Measurement

## R — Reading

> "TRIPODI, Senior Vice President, Global Marketing, Products and Services, MasterCard International Incorporated “Aaker’s ’brand system’ and his discussion of brand equity measurement should fundamentally change our perspectives on marketing.” —PETER A."
>
> — Source: BSB Ch10

**Source mechanism:** Apply the 10-category equity tracking system This skill encodes the method from BSB Ch10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Apply the 10-category equity tracking system The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BSB Ch10.
...
1. Apply the 10-category equity tracking system
...
- "how to apply the 10-category equity tracking system"
...
- **Method applied:** `aaker-book-brand-equity-ten-measurement`
...
- The problem is outside the scope of BSB Ch10.
