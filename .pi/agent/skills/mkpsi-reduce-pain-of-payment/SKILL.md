---
name: mkpsi-reduce-pain-of-payment
description: |
  Use when: Conversion stalls at payment, sticker shock, currency symbols, checkout, or spend recall. 
  Trigger phrases: price resistance,, sticker shock,, checkout friction,, per day,, £3.99,, payment me
  thod,. NOT for: Do not obscure total costs, fees, APR, subscriptions, or legally required disclosure
  s. Use especially carefully in financial products.
source_book: |
...
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-change-the-comparison-set, mkpsi-benefits-before-costs-ordering, mkpsi-reframe-equivalent-options]
disable-model-invocation: true
---

# Make price feel less painful without hiding total cost.

## R — Reading

> “Any means by which you can distance the consumer from the tangibility of money will reduce price sensitivity.”
>
> — Source: Bias 6: The Pain of Payment.

**Source mechanism:** - **Recognize:** Conversion stalls at payment or buyers recall the purchase as expensive.
- **Intervene:** Use cashless/prepaid mechanics, remove currency symbols where appropriate, charm-price, divide cost into smaller time frames, or give the promotion a credible story.
- **Assess:** Track basket size, conversion, remembered spend, perceived value, and margin impact.
...
- **Recognize:** Conversion stalls at payment or buyers recall the purchase as expensive.
- **Intervene:** Use cashless/prepaid mechanics, remove currency symbols where appropriate, charm-price, divide cost into smaller time frames, or give the promotion a credible story.
- **Assess:** Track basket size, conversion, remembered spend, perceived value, and margin impact.
...
### Case 1: MIT auction participants bid $61 for basketball tickets when paying by card vs $
- **Problem:** MIT auction participants bid $61 for basketball tickets when paying by card vs $29 when paying cash.
...
### Case 2: Cornell menu research found removing dollar signs from menus boosted sales by 8%
- **Problem:** Cornell menu research found removing dollar signs from menus boosted sales by 8%.
...
1. Conversion stalls at payment, sticker shock, currency symbols, checkout, or spend recall.
...
- Sibling confusion risks: - Price relativity changes comparison set; pain of payment changes the felt salience of paying.
- Veblen price signaling can require higher visible prices, not hiding price.

---

## E — Execution steps

1. **Apply the source method: - **Recognize:** Conversion stalls at payment or buyers recall the purchase as expensive. - **Intervene:** Use cashless/prepaid mechanics, remove currency symbols where appropriate, charm-price, divide cost into smaller time frames, or give the promotion a credible story. - **Assess:** Track basket size, conversion, remembered spend, perceived value, and margin impact.**
...
- **Selected mechanism:** `mkpsi-reduce-pain-of-payment` — Make price feel less painful without hiding total cost.
...
- Do not obscure total costs, fees, APR, subscriptions, or legally required disclosures. Use especially carefully in financial products.
...
- Price relativity changes comparison set; pain of payment changes the felt salience of paying.
- Veblen price signaling can require higher visible prices, not hiding price.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-change-the-comparison-set, /mkpsi-benefits-before-costs-ordering, /mkpsi-reframe-equivalent-options
