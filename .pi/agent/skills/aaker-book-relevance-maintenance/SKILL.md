---
name: aaker-book-relevance-maintenance
description: |
  Use when: Maintain relevance as the category evolves. Trigger phrases: "relevance maintenance", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
**Source mechanism:** Maintain relevance as the category evolves This skill encodes the method from BR Ch10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Maintain relevance as the category evolves The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BR Ch10.
...
1. Maintain relevance as the category evolves
...
- "how to maintain relevance as the category evolves"
...
- **Method applied:** `aaker-book-relevance-maintenance`
...
- The problem is outside the scope of BR Ch10.
