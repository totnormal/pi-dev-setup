---
name: aaker-book-brand-awareness-strategy
description: |
  Use when: Build recognition/recall, manage the awareness pyramid. Trigger phrases: "brand awareness strategy", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Brand Awareness ¹ The Nissan material is in part drawn from Anastasia C."
>
> — Source: MBE Ch3

**Source mechanism:** Build recognition/recall, manage the awareness pyramid This skill encodes the method from MBE Ch3 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Build recognition/recall, manage the awareness pyramid The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch3.
...
1. Build recognition/recall, manage the awareness pyramid
...
- "how to build recognition/recall, manage the awareness pyramid"
...
- **Method applied:** `aaker-book-brand-awareness-strategy`
...
- The problem is outside the scope of MBE Ch3.
