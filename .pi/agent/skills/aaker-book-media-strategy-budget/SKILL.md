---
name: aaker-book-media-strategy-budget
description: |
  Use when: Set media strategy and advertising budgets. Trigger phrases: "media strategy budget", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "The importance of setting advertising budgets using careful analysis, rather than industry rules of thumb or "gut feel," cannot be overemphasized. Various studies have repeatedly shown that the average advertising elasticity is small, about only 0.22 percent."
>
> — Source: AM Ch16

**Source mechanism:** Set media strategy and advertising budgets This skill encodes the method from AM Ch16 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Set media strategy and advertising budgets The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch16.
...
1. Set media strategy and advertising budgets
...
- "how to set media strategy and advertising budgets"
...
- **Method applied:** `aaker-book-media-strategy-budget`
...
- The problem is outside the scope of AM Ch16.
