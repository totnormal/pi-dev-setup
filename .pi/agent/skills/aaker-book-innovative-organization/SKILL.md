---
name: aaker-book-innovative-organization
description: |
  Use when: Build the organizational capacity for continuous innovation. Trigger phrases: "innovative organization", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "It seems clear that success is about winning not the brand preference battle but, rather, the brand relevance war with an innovative offering that achieves sustainable differentiation by creating a new category or subcategory."
>
> — Source: BR Ch11

**Source mechanism:** Build the organizational capacity for continuous innovation This skill encodes the method from BR Ch11 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Build the organizational capacity for continuous innovation The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BR Ch11.
...
1. Build the organizational capacity for continuous innovation
...
- "how to build the organizational capacity for continuous innovation"
...
- **Method applied:** `aaker-book-innovative-organization`
...
- The problem is outside the scope of BR Ch11.
