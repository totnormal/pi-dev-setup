---
name: aaker-book-organizing-brand-building
description: |
  Use when: Structure the org for brand building (brand czar, team, committees). Trigger phrases: "organizing brand building", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
  Managing Brand Equity (1991) + Building Strong Brands (1995) — David A. Aaker
source_chapter: |
  BSB Ch11
tags: [aaker-books, equity, p1]
related_skills: [aaker-book-equity-orchestrator, aaker-book-equity-verifier, aaker-book-orchestrator, aaker-book-output-verifier]
...
> "Such brands are competitive with national brands in quality and marketing support but have substantial cost advantages—in part because the cost of the brand management team, sales force, and advertising is lower and can be spread over hundreds of product classes and in part becau"
>
> — Source: BSB Ch11

**Source mechanism:** Structure the org for brand building (brand czar, team, committees) This skill encodes the method from BSB Ch11 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Structure the org for brand building (brand czar, team, committees) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Applied across multiple cases in Managing Brand Equity (1991) + Building Strong Brands (1995) — David A. Aaker.
...
- **Result/evidence:** Corroborating case from BSB Ch11.
...
1. Structure the org for brand building (brand czar, team, committees)
...
- "how to structure the org for brand building (brand czar, team, committees)"

### Distinction from siblings
- Use `/aaker-book-orchestrator` when unsure which Aaker skill applies.
- Use `aaker-book-equity-verifier` to QA the output of this skill.
- See the set INDEX for sibling skills within Set 1: Brand Equity Foundations.
...
- **Method applied:** `aaker-book-organizing-brand-building`
...
- The problem is outside the scope of BSB Ch11.
...
- composes-with: `/aaker-book-equity-orchestrator`, `/aaker-book-equity-verifier`, `/aaker-book-orchestrator`
