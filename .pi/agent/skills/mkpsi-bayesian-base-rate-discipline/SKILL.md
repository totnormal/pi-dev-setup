---
name: mkpsi-bayesian-base-rate-discipline
description: |
  Use when: Vivid case description is used to infer category membership or probability. Trigger phrase
  s: sounds like the type,, perfect fit,, this startup looks different,, rare event,, case-specific ev
  idence,, what are the odds.. NOT for: Requires a plausible reference class. If multiple classes fit,
   present sensitivity across classes rather than false precision.
source_book: |
...
source_chapter: |
  Ch. 14 “Tom W’s Specialty,” “How to Discipline Intuition”
tags: [mkpsi-v2, bias, p1]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-reference-class-forecast, mkpsi-haystack-search-sweet-spot, mkpsi-expert-intuition-validity-test]
disable-model-invocation: true
---

# Anchor probabilities on base rates, then adjust for diagnostic evidence.
...
>
> — Source: Ch. 14 “Tom W’s Specialty,” “How to Discipline Intuition”

**Source mechanism:** For classification or probability judgments, first state the relevant base rate; then state how diagnostic the case evidence is; move only as far from the base rate as evidence quality warrants.
...
For classification or probability judgments, first state the relevant base rate; then state how diagnostic the case evidence is; move only as far from the base rate as evidence quality warrants.
...
### Case 1: Tom W
- **Problem:** Tom W: psychology graduate students ranked fields by stereotype similarity, ignoring enrollment base rates.
...
### Case 2: Steve librarian/farmer
- **Problem:** Steve librarian/farmer: vivid “meek and tidy” description displaced the fact that farmers greatly outnumber librarians.
...
1. Vivid case description is used to infer category membership or probability.
...
- Sibling confusion risks: Related to outside view; this is for probability/category judgments, while outside view is for project forecasting using reference classes.

---

## E — Execution steps

1. **Apply the source method: For classification or probability judgments, first state the relevant base rate; then state how diagnostic the case evidence is; move only as far from the base rate as evidence quality warrants.**
...
- **Selected mechanism:** `mkpsi-bayesian-base-rate-discipline` — Anchor probabilities on base rates, then adjust for diagnostic evidence.
...
- Requires a plausible reference class. If multiple classes fit, present sensitivity across classes rather than false precision.
...
Related to outside view; this is for probability/category judgments, while outside view is for project forecasting using reference classes.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-reference-class-forecast, /mkpsi-haystack-search-sweet-spot, /mkpsi-expert-intuition-validity-test
