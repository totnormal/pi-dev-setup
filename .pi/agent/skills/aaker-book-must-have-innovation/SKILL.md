---
name: aaker-book-must-have-innovation
description: |
  Use when: Create must-haves that render competitors irrelevant. Trigger phrases: "must have innovation", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "CREATE “MUST HAVES” RENDERING COMPETITORS IRRELEVANT You don’t want to be considered just the best of the best; you want to be considered the only one who does what you do."
>
> — Source: AoB Ch7

**Source mechanism:** Create must-haves that render competitors irrelevant This skill encodes the method from AoB Pr7 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Create must-haves that render competitors irrelevant The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AoB Pr7.
...
1. Create must-haves that render competitors irrelevant
...
- "how to create must-haves that render competitors irrelevant"
...
- **Method applied:** `aaker-book-must-have-innovation`
...
- The problem is outside the scope of AoB Pr7.
