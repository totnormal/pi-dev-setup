---
name: aaker-book-brand-portfolio-roles
description: |
  Use when: Assign portfolio roles: strategic, energizer, silver-bullet, flanker, cash-cow. Trigger phrases: "brand portfolio roles", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Their consistently brilliant brand portfolio work for many dozens of clients over three continents was both inspirational and informative."
>
> — Source: BPS Ch1

**Source mechanism:** Assign portfolio roles: strategic, energizer, silver-bullet, flanker, cash-cow This skill encodes the method from BPS Ch1-2 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Assign portfolio roles: strategic, energizer, silver-bullet, flanker, cash-cow The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BPS Ch1-2.
...
1. Assign portfolio roles: strategic, energizer, silver-bullet, flanker, cash-cow
...
- "how to assign portfolio roles: strategic, energizer, silver-bullet, flanker, cash-cow"
...
- **Method applied:** `aaker-book-brand-portfolio-roles`
...
- The problem is outside the scope of BPS Ch1-2.
