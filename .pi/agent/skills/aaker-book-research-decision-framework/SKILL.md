---
name: aaker-book-research-decision-framework
description: |
  Use when: Frame research around the decision it supports. Trigger phrases: "research decision framework", "brand research", Aaker research. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "MARKETING RESEARCH This page is intentionally left blank MARKETING RESEARCH ELEVENTH EDITION DAVID A."
>
> — Source: MR Ch1

**Source mechanism:** Frame research around the decision it supports This skill encodes the method from MR Ch1 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Frame research around the decision it supports The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MR Ch1.
...
1. Frame research around the decision it supports
...
- "how to frame research around the decision it supports"
...
- **Method applied:** `aaker-book-research-decision-framework`
...
- The problem is outside the scope of MR Ch1.
