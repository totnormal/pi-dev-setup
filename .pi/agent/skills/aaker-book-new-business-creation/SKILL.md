---
name: aaker-book-new-business-creation
description: |
  Use when: Create new businesses via growth options. Trigger phrases: "new business creation", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Creating New Businesses to Go The New Business bo bo eS The Innovator’s Advantage 233 Managing Category Perceptions 236 Creating New Business Arenas 236 From Ideas to Market 241"
>
> — Source: SMM Ch12

**Source mechanism:** Create new businesses via growth options This skill encodes the method from SMM Ch12 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Create new businesses via growth options The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch12.
...
1. Create new businesses via growth options
...
- "how to create new businesses via growth options"
...
- **Method applied:** `aaker-book-new-business-creation`
...
- The problem is outside the scope of SMM Ch12.
