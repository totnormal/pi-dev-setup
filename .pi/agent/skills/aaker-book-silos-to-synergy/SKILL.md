---
name: aaker-book-silos-to-synergy
description: |
  Use when: Overcome silo organization, harness cross-SBU synergy. Trigger phrases: "silos to synergy", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "© Creating synergetic marketing with silo organizations defined by products or countries."
>
> — Source: SMM Ch15

**Source mechanism:** Overcome silo organization, harness cross-SBU synergy This skill encodes the method from SMM Ch15 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Overcome silo organization, harness cross-SBU synergy The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch15.
...
1. Overcome silo organization, harness cross-SBU synergy
...
- "how to overcome silo organization, harness cross-sbu synergy"
...
- **Method applied:** `aaker-book-silos-to-synergy`
...
- The problem is outside the scope of SMM Ch15.
