---
name: aaker-book-brand-new-market-leverage
description: |
  Use when: Leverage brands into new product-markets. Trigger phrases: "brand new market leverage", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Brand New Market Leverage

## R — Reading

> "- A linchpin brand will indirectly influence (as opposed to generate) significant sales and market position in the future, serving as the “linchpin” or leverage point of a major business area or of a future vision of the firm."
>
> — Source: BPS Ch7

**Source mechanism:** Leverage brands into new product-markets This skill encodes the method from BPS Ch7 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Leverage brands into new product-markets The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BPS Ch7.
...
1. Leverage brands into new product-markets
...
- "how to leverage brands into new product-markets"
...
- **Method applied:** `aaker-book-brand-new-market-leverage`
...
- The problem is outside the scope of BPS Ch7.
