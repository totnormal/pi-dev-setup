---
name: mkpsi-self-image-symbol-fit
description: |
  Use when: “Brand personality,” “identity signal,” “what does this say about me,” functionally simila
  r products. Trigger phrases: brand personality,, identity signal,, people can’t tell products apart,
  , what does this say about me,, self-image buyer.. NOT for: Do not stereotype individuals rigidly; d
  o not promise identity transformation the product cannot support; avoid discriminatory class/gender 
  profiling.
source_book: |
...
source_chapter: |
  Ch. 5 “Self-Images for Everybody”; Ch. 12 “Selling Symbols to Upward Strivers”
tags: [mkpsi-v2, value, p2]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-reframe-with-meaning, mkpsi-distinctive-identity-feedback-loop]
disable-model-invocation: true
---

# Align brand symbols with the buyer’s self-image.

## R — Reading

> “In buying a gasoline you get played back to you who are. Each gasoline has built up an image or personality. Each helps a buyer answer the question ‘Who am I?’”
>
> — Source: Ch. 5 “Self-Images for Everybody”; Ch. 12 “Selling Symbols to Upward Strivers”

**Source mechanism:** - **Recognize:** Products are functionally similar or hard to differentiate rationally.
- **Interpret:** Buyers may be selecting the image that reflects who they are or wish to be.
- **Act:** Define the target self-image, choose symbols that embody it, remove contradictions, and test whether the target audience recognizes itself in the offer.
...
- **Recognize:** Products are functionally similar or hard to differentiate rationally.
- **Interpret:** Buyers may be selecting the image that reflects who they are or wish to be.
- **Act:** Define the target self-image, choose symbols that embody it, remove contradictions, and test whether the target audience recognizes itself in the offer.
...
### Case 1: Cigarette smokers showed strong brand loyalty despite blind tests where they cou
- **Problem:** Cigarette smokers showed strong brand loyalty despite blind tests where they could not identify their own brand.
...
### Case 2: Car owners selected makes and styles as “portable symbols” of personality and po
- **Problem:** Car owners selected makes and styles as “portable symbols” of personality and position.
...
1. “Brand personality,” “identity signal,” “what does this say about me,” functionally similar products.
...
- "brand personality,"
- "identity signal,"
- "people can’t tell products apart,"
...
- Sibling confusion risks: - Not mere aesthetics; image must mirror a buyer identity.
- Not status selling only; can be friendliness, authority, masculinity, sophistication, responsibility, or rebellion.
- Not a claim of real personality diagnosis from purchases.

---

## E — Execution steps

1. **Apply the source method: - **Recognize:** Products are functionally similar or hard to differentiate rationally. - **Interpret:** Buyers may be selecting the image that reflects who they are or wish to be. - **Act:** Define the target self-image, choose symbols that embody it, remove contradictions, and test whether the target audience recognizes itself in the offer.**
...
- **Selected mechanism:** `mkpsi-self-image-symbol-fit` — Align brand symbols with the buyer’s self-image.
...
- Do not stereotype individuals rigidly; do not promise identity transformation the product cannot support; avoid discriminatory class/gender profiling.
...
- Not mere aesthetics; image must mirror a buyer identity.
- Not status selling only; can be friendliness, authority, masculinity, sophistication, responsibility, or rebellion.
- Not a claim of real personality diagnosis from purchases.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-reframe-with-meaning, /mkpsi-distinctive-identity-feedback-loop
