---
name: mkpsi-benefits-before-costs-ordering
description: |
  Use when: Offer has many units, hours, deliverables, services, or outcomes and value math is not obv
  ious. Trigger phrases: X deliverables for $Y, lead with value, item-then-price, what the savings buy
  s, opportunity cost.. NOT for: Do not obscure total cost. For simple, low-unit offers the effect may
   be smaller. Ensure benefits are comparable and real.
source_book: |
...
source_chapter: |
  Chapter 38, “change in order”; Chapter 42, “opportunity costs.”
tags: [mkpsi-v2, general, p2]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-sequence-first-impression, mkpsi-reduce-pain-of-payment, mkpsi-change-the-comparison-set]
disable-model-invocation: true
---

# Present benefits/items before price when offers are complex.

## R — Reading

> “As choices increase in complexity our attention is directed to the very first piece of information presented, be it the number of items, price, amount of time, or any other unit or measurement.”
>
> — Source: Chapter 38, “change in order”; Chapter 42, “opportunity costs.”

**Source mechanism:** - **Recognize:** The offer bundles many units, hours, deliverables, services, or outcomes and the value math is not instantly obvious.
- **Intervene:** Lead with the concrete benefits/items/outcomes, then state price; make opportunity-cost savings explicit when relevant.
- **Assess:** Compare trial, purchase, or approval rates against price-first ordering.
...
- **Recognize:** The offer bundles many units, hours, deliverables, services, or outcomes and the value math is not instantly obvious.
- **Intervene:** Lead with the concrete benefits/items/outcomes, then state price; make opportunity-cost savings explicit when relevant.
- **Assess:** Compare trial, purchase, or approval rates against price-first ordering.
...
### Case 1: **Recognize
- **Problem:** **Recognize:** The offer bundles many units, hours, deliverables, services, or outcomes and the value math is not instantly obvious.
...
### Case 2: **Intervene
- **Problem:** **Intervene:** Lead with the concrete benefits/items/outcomes, then state price; make opportunity-cost savings explicit when relevant.
...
1. Offer has many units, hours, deliverables, services, or outcomes and value math is not obvious.
...
- Sibling confusion risks: - Not perceptual contrast alone; this skill orders benefit and cost inside one offer.
- Not unit-asking; it does not ask value of one unit first.

---

## E — Execution steps

1. **Apply the source method: - **Recognize:** The offer bundles many units, hours, deliverables, services, or outcomes and the value math is not instantly obvious. - **Intervene:** Lead with the concrete benefits/items/outcomes, then state price; make opportunity-cost savings explicit when relevant. - **Assess:** Compare trial, purchase, or approval rates against price-first ordering.**
...
- **Selected mechanism:** `mkpsi-benefits-before-costs-ordering` — Present benefits/items before price when offers are complex.
...
- Do not obscure total cost. For simple, low-unit offers the effect may be smaller. Ensure benefits are comparable and real.
...
- Not perceptual contrast alone; this skill orders benefit and cost inside one offer.
- Not unit-asking; it does not ask value of one unit first.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-sequence-first-impression, /mkpsi-reduce-pain-of-payment, /mkpsi-change-the-comparison-set
