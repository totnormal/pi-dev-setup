...
description: "Ai search optimization. > This skill covers strategies for visibility in ChatGPT, Perplexity, Google AI Overviews, Microsoft Copilot, and other generative AI platforms"
---
...
> **Mega-skill note:** This skill is the canonical home for both ai-search-optimization and geo-content-optimizer workflows, so the AEO and GEO guidance stays in one place.
...
## Sources
- Base: `manojbajaj95__gtm-skills__ai-search-optimization.md`
- Merged: `manojbajaj95__gtm-skills__aeo-scorecard.md`
- Merged: `manojbajaj95__gtm-skills__geo-aeo-optimization.md`
