---
name: aaker-book-organizational-associations
description: |
  Use when: Build trust via organizational attributes (culture, values, programs). Trigger phrases: "organizational associations", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Organizational Associations The Body Shop Story The Story of Branding in Japan The Brand as Organization Organizational Associations How Organizational Associations Work 5."
>
> — Source: BSB Ch4

**Source mechanism:** Build trust via organizational attributes (culture, values, programs) This skill encodes the method from BSB Ch4 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Build trust via organizational attributes (culture, values, programs) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BSB Ch4.
...
1. Build trust via organizational attributes (culture, values, programs)
...
- "how to build trust via organizational attributes (culture, values, programs)"
...
- **Method applied:** `aaker-book-organizational-associations`
...
- The problem is outside the scope of BSB Ch4.
