---
name: aaker-book-marketing-mix-measurement
description: |
  Use when: Measure marketing-mix effectiveness. Trigger phrases: "marketing mix measurement", "brand research", Aaker research. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "The section on Applications of Marketing Intelligence has been revised and re-arranged along the lines of measures, metrics, and strategies that help companies in implementing the concepts of marketing research."
>
> — Source: MR Ch23

**Source mechanism:** Measure marketing-mix effectiveness This skill encodes the method from MR Ch23 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Measure marketing-mix effectiveness The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MR Ch23.
...
1. Measure marketing-mix effectiveness
...
- "how to measure marketing-mix effectiveness"
...
- **Method applied:** `aaker-book-marketing-mix-measurement`
...
- The problem is outside the scope of MR Ch23.
