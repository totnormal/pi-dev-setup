---
name: aaker-book-copywriting-craft
description: |
  Use when: Apply copywriting craft principles. Trigger phrases: "copywriting craft", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "The Art of Copywriting 414 The Creative Process: Coming up with an Idea 415 Copywriting 421 Illustrating 435 Layout 436 Types of Television Commercials 437 Creative Styles 439 Is Execution More Important Than Content?"
>
> — Source: AM Ch13

**Source mechanism:** Apply copywriting craft principles This skill encodes the method from AM Ch13 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Apply copywriting craft principles The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch13.
...
1. Apply copywriting craft principles
...
- "how to apply copywriting craft principles"
...
- **Method applied:** `aaker-book-copywriting-craft`
...
- The problem is outside the scope of AM Ch13.
