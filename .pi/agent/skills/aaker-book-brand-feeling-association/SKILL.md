---
name: aaker-book-brand-feeling-association
description: |
  Use when: Associate feelings and emotions with the brand. Trigger phrases: "brand feeling association", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Brand Feeling Association

## R — Reading

> "Associating Feelings with the Brand 279 When are Feelings More Important?"
>
> — Source: AM Ch9

**Source mechanism:** Associate feelings and emotions with the brand This skill encodes the method from AM Ch9 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Associate feelings and emotions with the brand The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch9.
...
1. Associate feelings and emotions with the brand
...
- "how to associate feelings and emotions with the brand"
...
- **Method applied:** `aaker-book-brand-feeling-association`
...
- The problem is outside the scope of AM Ch9.
