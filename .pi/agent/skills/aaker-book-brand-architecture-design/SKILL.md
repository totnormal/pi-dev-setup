---
name: aaker-book-brand-architecture-design
description: |
  Use when: Design multi-brand architecture (house of brands ↔ branded house). Trigger phrases: "brand architecture design", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "The concept of a subbrand structure needing to have a logic was proposed by Scott Talgo of the St."
>
> — Source: BL Ch5

**Source mechanism:** Design multi-brand architecture (house of brands ↔ branded house) This skill encodes the method from BL Ch5 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Design multi-brand architecture (house of brands ↔ branded house) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BL Ch5.
...
1. Design multi-brand architecture (house of brands ↔ branded house)
...
- "how to design multi-brand architecture (house of brands ↔ branded house)"
...
- **Method applied:** `aaker-book-brand-architecture-design`
...
- The problem is outside the scope of BL Ch5.
