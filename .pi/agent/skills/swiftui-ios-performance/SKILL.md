...
name: swiftui-ios-performance
description: Audit SwiftUI view performance end-to-end, from instrumentation and baselining to root-cause analysis and concrete remediation steps.
---
...
See [references/optimizing-swiftui-performance-instruments.md](https://github.com/dpearson2699/swift-ios-skills/blob/HEAD/skills/swiftui-performance/references/optimizing-swiftui-performance-instruments.md) for the full profiling workflow.
...
* Demystify SwiftUI performance (WWDC23): [references/demystify-swiftui-performance-wwdc23.md](https://github.com/dpearson2699/swift-ios-skills/blob/HEAD/skills/swiftui-performance/references/demystify-swiftui-performance-wwdc23.md)
* Optimizing SwiftUI performance with Instruments: [references/optimizing-swiftui-performance-instruments.md](https://github.com/dpearson2699/swift-ios-skills/blob/HEAD/skills/swiftui-performance/references/optimizing-swiftui-performance-instruments.md)
* Understanding hangs in your app: [references/understanding-hangs-in-your-app.md](https://github.com/dpearson2699/swift-ios-skills/blob/HEAD/skills/swiftui-performance/references/understanding-hangs-in-your-app.md)
* Understanding and improving SwiftUI performance: [references/understanding-improving-swiftui-performance.md](https://github.com/dpearson2699/swift-ios-skills/blob/HEAD/skills/swiftui-performance/references/understanding-improving-swiftui-performance.md)
* WWDC transcript sources: [references/wwdc-session-sources.md](https://github.com/dpearson2699/swift-ios-skills/blob/HEAD/skills/swiftui-performance/references/wwdc-session-sources.md)
