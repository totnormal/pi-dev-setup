---
name: aaker-book-internal-analysis
description: |
  Use when: Assess performance, cost position, differentiation, brand. Trigger phrases: "internal analysis", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Internal Analysis 99 Financial Analysis — Sales and Profitability 100 Performance Measurement — Beyond Profitability 103 Strengths and Weaknesses 107 Threats and Opportunities 109 From Analysis to Strategy 110 Cases for the End of Part I 113 Case | — Understanding and Working wit"
>
> — Source: SMM Ch6

**Source mechanism:** Assess performance, cost position, differentiation, brand This skill encodes the method from SMM Ch6 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Assess performance, cost position, differentiation, brand The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch6.
...
1. Assess performance, cost position, differentiation, brand
...
- "how to assess performance, cost position, differentiation, brand"
...
- **Method applied:** `aaker-book-internal-analysis`
...
- The problem is outside the scope of SMM Ch6.
