---
name: aaker-book-brand-customer-metrics
description: |
  Use when: Apply brand and customer equity metrics. Trigger phrases: "brand customer metrics", "brand research", Aaker research. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "A basic indicator of loyalty is the amount a customer will pay for the brand in comparison with another brand offering similar or fewer benefits. This is called the price premium associated with the brand's loyalty, and it may be high or low and positive or negative."
>
> — Source: BSB Ch10, MR Ch24

**Source mechanism:** Apply brand and customer equity metrics This skill encodes the method from MR Ch24 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Apply brand and customer equity metrics The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MR Ch24.
...
1. Apply brand and customer equity metrics
...
- "how to apply brand and customer equity metrics"
...
- **Method applied:** `aaker-book-brand-customer-metrics`
...
- The problem is outside the scope of MR Ch24.
