---
name: aaker-book-portfolio-inputs-decisions
description: |
  Use when: Gather portfolio inputs (market, brand, competition, strategy). Trigger phrases: "portfolio inputs decisions", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Portfolio Inputs Decisions

## R — Reading

> "[] [Image] BRAND PORTFOLIO STRATEGY Creating Relevance, Differentiation, Energy, Leverage, and Clarity [Image] DAVID A."
>
> — Source: BPS Ch3

**Source mechanism:** Gather portfolio inputs (market, brand, competition, strategy) This skill encodes the method from BPS Ch3 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Gather portfolio inputs (market, brand, competition, strategy) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BPS Ch3.
...
1. Gather portfolio inputs (market, brand, competition, strategy)
...
- "how to gather portfolio inputs (market, brand, competition, strategy)"
...
- **Method applied:** `aaker-book-portfolio-inputs-decisions`
...
- The problem is outside the scope of BPS Ch3.
