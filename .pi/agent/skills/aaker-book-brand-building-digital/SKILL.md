---
name: aaker-book-brand-building-digital
description: |
  Use when: Use the web/digital as a brand-building vehicle. Trigger phrases: "brand building digital", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Brand Building Digital

## R — Reading

> "The authors thank Jason Stavers and Andy Smith, two world-class Internet observers, for their insightful contributions to this chapter."
>
> — Source: BL Ch8

**Source mechanism:** Use the web/digital as a brand-building vehicle This skill encodes the method from BL Ch8 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Use the web/digital as a brand-building vehicle The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BL Ch8.
...
1. Use the web/digital as a brand-building vehicle
...
- "how to use the web/digital as a brand-building vehicle"
...
- **Method applied:** `aaker-book-brand-building-digital`
...
- The problem is outside the scope of BL Ch8.
