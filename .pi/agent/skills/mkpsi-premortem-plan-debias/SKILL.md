---
name: mkpsi-premortem-plan-debias
description: |
  Use when: Team is excited, aligned, politically committed, or suppressing doubt before approval. Tri
  gger phrases: we’re aligned,, no blockers,, this can’t fail,, approval meeting,, major investment,, 
  everyone is excited.. NOT for: Avoid becoming a generic brainstorming session; require specific fail
  ure causes. Does not replace quantitative risk analysis.
source_book: |
...
source_chapter: |
  Ch. 24 “The Engine of Capitalism,” discussion of Gary Klein’s premortem
tags: [mkpsi-v2, bias, p1]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-decorrelate-judgment, mkpsi-reference-class-forecast, mkpsi-stranger-risk-pre-mortem]
disable-model-invocation: true
---

# Run a premortem before committing to a risky plan.
...
>
> — Source: Ch. 24 “The Engine of Capitalism,” discussion of Gary Klein’s premortem

**Source mechanism:** Before final approval, announce the project has failed in the future; ask each participant to independently write the reasons; aggregate threats and revise/stop the plan.
...
Before final approval, announce the project has failed in the future; ask each participant to independently write the reasons; aggregate threats and revise/stop the plan.
...
### Case 1: Entrepreneurs and CEOs underestimate odds, competition, and luck while focusing 
- **Problem:** Entrepreneurs and CEOs underestimate odds, competition, and luck while focusing on plans and capabilities.
...
### Case 2: Inventors persisted after objective D/E failure grades, often doubling losses be
- **Problem:** Inventors persisted after objective D/E failure grades, often doubling losses before quitting.
...
1. Team is excited, aligned, politically committed, or suppressing doubt before approval.
...
- Sibling confusion risks: Premortem is not outside-view statistics; it is structured doubt generation. Best used with reference-class forecasting.

---

## E — Execution steps

1. **Apply the source method: Before final approval, announce the project has failed in the future; ask each participant to independently write the reasons; aggregate threats and revise/stop the plan.**
...
- **Selected mechanism:** `mkpsi-premortem-plan-debias` — Run a premortem before committing to a risky plan.
...
- Avoid becoming a generic brainstorming session; require specific failure causes. Does not replace quantitative risk analysis.
...
Premortem is not outside-view statistics; it is structured doubt generation. Best used with reference-class forecasting.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-decorrelate-judgment, /mkpsi-reference-class-forecast, /mkpsi-stranger-risk-pre-mortem
