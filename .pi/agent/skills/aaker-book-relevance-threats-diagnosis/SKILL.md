---
name: aaker-book-relevance-threats-diagnosis
description: |
  Use when: Diagnose the 3 threats: subcategory emergence, decline, loss of energy. Trigger phrases: "relevance threats diagnosis", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Relevance Threats Diagnosis

## R — Reading

> "Internal Branding: A Key Ingredient Part IV Maintain Relevance 15."
>
> — Source: AoB Ch15

**Source mechanism:** Diagnose the 3 threats: subcategory emergence, decline, loss of energy This skill encodes the method from AoB Pr15 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Diagnose the 3 threats: subcategory emergence, decline, loss of energy The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AoB Pr15.
...
1. Diagnose the 3 threats: subcategory emergence, decline, loss of energy
...
- "how to diagnose the 3 threats: subcategory emergence, decline, loss of energy"
...
- **Method applied:** `aaker-book-relevance-threats-diagnosis`
...
- The problem is outside the scope of AoB Pr15.
