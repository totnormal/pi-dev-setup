---
name: aaker-book-qualitative-research-methods
description: |
  Use when: Apply focus groups, depth interviews, ethnography. Trigger phrases: "qualitative research methods", "brand research", Aaker research. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "In-depth interviews are a method that provides more information for less money without many of the limitations focus groups can impose. Unlike in focus groups, one-on-one interviews can avoid responses that are influenced by other people."
>
> — Source: MR Ch8

**Source mechanism:** Apply focus groups, depth interviews, ethnography This skill encodes the method from MR Ch8 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Apply focus groups, depth interviews, ethnography The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MR Ch8.
...
1. Apply focus groups, depth interviews, ethnography
...
- "how to apply focus groups, depth interviews, ethnography"
...
- **Method applied:** `aaker-book-qualitative-research-methods`
...
- The problem is outside the scope of MR Ch8.
