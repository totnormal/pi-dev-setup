---
name: aaker-book-brand-category-linkage
description: |
  Use when: Link the brand to the category so competitors can't decouple. Trigger phrases: "brand category linkage", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
  Brand Relevance (2011) + Aaker on Branding (2014) — David A. Aaker
source_chapter: |
  BR Ch9-10
tags: [aaker-books, relevance, p1]
related_skills: [aaker-book-relevance-orchestrator, aaker-book-relevance-verifier, aaker-book-orchestrator, aaker-book-output-verifier]
disable-model-invocation: true
---

# Brand Category Linkage

## R — Reading

> "The ultimate is to have the brand represent the category or subcategory as its exemplar. A customer will describe the category or subcategory in terms of the exemplar: I want Jell-O, A.1., an iPod, or a comparable product."
>
> — Source: BR Ch9-10

**Source mechanism:** Link the brand to the category so competitors can't decouple This skill encodes the method from BR Ch9-10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Link the brand to the category so competitors can't decouple The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Applied across multiple cases in Brand Relevance (2011) + Aaker on Branding (2014) — David A. Aaker.
...
- **Result/evidence:** Corroborating case from BR Ch9-10.
...
1. Link the brand to the category so competitors can't decouple
...
- "brand category linkage"
- "Aaker relevance"
- "brand relevance framework"
- "how to link the brand to the category so competitors can't decouple"

### Distinction from siblings
- Use `/aaker-book-orchestrator` when unsure which Aaker skill applies.
- Use `aaker-book-relevance-verifier` to QA the output of this skill.
- See the set INDEX for sibling skills within Set 3: Brand Relevance & Innovation.
...
- **Method applied:** `aaker-book-brand-category-linkage`
...
- The problem is outside the scope of BR Ch9-10.
...
- composes-with: `/aaker-book-relevance-orchestrator`, `/aaker-book-relevance-verifier`, `/aaker-book-orchestrator`
