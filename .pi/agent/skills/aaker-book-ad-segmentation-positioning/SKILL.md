---
name: aaker-book-ad-segmentation-positioning
description: |
  Use when: Segment audiences and position advertising messages. Trigger phrases: "ad segmentation positioning", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
  Advertising Management (1996) — Batra, Myers, Aaker
source_chapter: |
  AM Ch6
tags: [aaker-books, advertising, p1]
related_skills: [aaker-book-advertising-orchestrator, aaker-book-advertising-verifier, aaker-book-orchestrator, aaker-book-output-verifier]
disable-model-invocation: true
---

# Ad Segmentation Positioning

## R — Reading

> "Segmentation and Positioning 173 Segmentation Strategy 174 Positioning Strategies 190 Determining the Positioning Strategy 201 Making the Positioning Decision 210 Summary 213 Discussion Questions 214 Notes 215 Part ill Message Strategy"
>
> — Source: AM Ch6

**Source mechanism:** Segment audiences and position advertising messages This skill encodes the method from AM Ch6 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Segment audiences and position advertising messages The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Applied across multiple cases in Advertising Management (1996) — Batra, Myers, Aaker.
...
- **Result/evidence:** Corroborating case from AM Ch6.
...
1. Segment audiences and position advertising messages
...
- "ad segmentation positioning"
- "Aaker advertising"
- "brand advertising framework"
- "how to segment audiences and position advertising messages"

### Distinction from siblings
- Use `/aaker-book-orchestrator` when unsure which Aaker skill applies.
- Use `aaker-book-advertising-verifier` to QA the output of this skill.
- See the set INDEX for sibling skills within Set 5: Advertising & Brand Building.
...
- **Method applied:** `aaker-book-ad-segmentation-positioning`
...
- The problem is outside the scope of AM Ch6.
...
- composes-with: `/aaker-book-advertising-orchestrator`, `/aaker-book-advertising-verifier`, `/aaker-book-orchestrator`
