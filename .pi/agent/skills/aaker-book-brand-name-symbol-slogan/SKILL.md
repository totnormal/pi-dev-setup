---
name: aaker-book-brand-name-symbol-slogan
description: |
  Use when: Select and evaluate names, symbols, slogans. Trigger phrases: "brand name symbol slogan", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "The Name, Symbol, and Slogan ¹ Material is drawn from Andy Keane, The Volkswagen Story, MBA Thesis, University of California, Berkeley, 1990; “A Battered VW Begins the Long Road Back,” Business Week, February 5, 1972, pp."
>
> — Source: MBE Ch8

**Source mechanism:** Select and evaluate names, symbols, slogans This skill encodes the method from MBE Ch8 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Select and evaluate names, symbols, slogans The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch8.
...
1. Select and evaluate names, symbols, slogans
...
- "how to select and evaluate names, symbols, slogans"
...
- **Method applied:** `aaker-book-brand-name-symbol-slogan`
...
- The problem is outside the scope of MBE Ch8.
