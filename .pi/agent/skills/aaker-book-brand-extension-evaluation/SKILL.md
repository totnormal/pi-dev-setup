---
name: aaker-book-brand-extension-evaluation
description: |
  Use when: Evaluate vertical/lateral extensions, avoid dilution. Trigger phrases: "brand extension evaluation", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "More good: the extension reinforces the associations and awareness of the brand. Bad: the name does not add value to the extension or even has negative associations. Ugly: the core brand name is damaged or diluted by the extension, or the brand franchise is cannibalized."
>
> — Source: MBE Ch9, BSB Ch9

**Source mechanism:** Evaluate vertical/lateral extensions, avoid dilution This skill encodes the method from MBE Ch9, BSB Ch9 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Evaluate vertical/lateral extensions, avoid dilution The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch9, BSB Ch9.
...
1. Evaluate vertical/lateral extensions, avoid dilution
...
- "how to evaluate vertical/lateral extensions, avoid dilution"
...
- **Method applied:** `aaker-book-brand-extension-evaluation`
...
- The problem is outside the scope of MBE Ch9, BSB Ch9.
