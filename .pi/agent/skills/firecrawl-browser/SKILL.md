...
description: "Firecrawl interact (formerly browser). Interact with scraped pages in a live browser session. Keywords: web scraping, crawling, data extraction, web automation, firecrawl browser."
---
