---
name: mkpsi-decorrelate-judgment
description: |
  Use when: “Let’s discuss first,” committee review, prioritization, panel decision, group verdict. Tr
  igger phrases: let’s discuss first,, what does everyone think,, review meeting,, committee,, rank th
  ese,, brainstorm verdict.. NOT for: Requires multiple judges or separable judgments. It does not rem
  ove shared systematic bias; combine with base-rate or outside-view checks when applicable.
source_book: |
...
source_chapter: |
  Ch. 7 “A Machine for Jumping to Conclusions,” “Exaggerated Emotional Coherence (Halo Effect)” and “S
  peaking of Jumping to Conclusions”
tags: [mkpsi-v2, bias, p1]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-premortem-plan-debias, mkpsi-simple-formula-selection, mkpsi-holy-fool-escalation-channel]
disable-model-invocation: true
---

# Preserve independent signals before group discussion.
...
>
> — Source: Ch. 7 “A Machine for Jumping to Conclusions,” “Exaggerated Emotional Coherence (Halo Effect)” and “Speaking of Jumping to Conclusions”

**Source mechanism:** When collecting judgments from multiple people/agents, require each judge to write a brief independent position before discussion; aggregate first-pass views before debate.
...
When collecting judgments from multiple people/agents, require each judge to write a brief independent position before discussion; aggregate first-pass views before debate.
...
### Case 1: Kahneman’s essay grading
- **Problem:** Kahneman’s essay grading: scoring all answers to one question before moving to the next reduced halo from the first essay.
...
### Case 2: Witnesses/jar estimates
- **Problem:** Witnesses/jar estimates: independent errors average out; shared influence reduces effective sample size.
...
1. “Let’s discuss first,” committee review, prioritization, panel decision, group verdict.
...
- Sibling confusion risks: Related to anti-halo procedures, but this candidate specifically preserves independent information before social influence.

---

## E — Execution steps

1. **Apply the source method: When collecting judgments from multiple people/agents, require each judge to write a brief independent position before discussion; aggregate first-pass views before debate.**
...
- **Selected mechanism:** `mkpsi-decorrelate-judgment` — Preserve independent signals before group discussion.
...
- Requires multiple judges or separable judgments. It does not remove shared systematic bias; combine with base-rate or outside-view checks when applicable.
...
Related to anti-halo procedures, but this candidate specifically preserves independent information before social influence.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-premortem-plan-debias, /mkpsi-simple-formula-selection, /mkpsi-holy-fool-escalation-channel
