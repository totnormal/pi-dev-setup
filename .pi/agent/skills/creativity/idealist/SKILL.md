---
name: idealist-idea-generator
disable-model-invocation: true
description: Rapid idea generation, refinement, and scoring for creative problem-solving and product ideation
when_to_use: when brainstorming new features, products, solutions, or any creative exploration where multiple ideas should be generated and evaluated
version: 1.0.0
---
...
**Before Idealist:**
- `skills/collaboration/brainstorming` - For understanding requirements and context

**After Idealist:**
- `skills/collaboration/writing-plans` - When ready to create implementation plans
- `skills/architecture/preserving-productive-tensions` - When approaches have genuine trade-offs
