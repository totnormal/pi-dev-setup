---
name: aaker-book-brand-building-beyond-advertising
description: |
  Use when: Build brands via PR, events, retail, CSR beyond advertising. Trigger phrases: "brand building beyond advertising", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "BUILDING BRANDS— BEYOND MEDIA ADVERTISING 1."
>
> — Source: BL Ch9

**Source mechanism:** Build brands via PR, events, retail, CSR beyond advertising This skill encodes the method from BL Ch9 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Build brands via PR, events, retail, CSR beyond advertising The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BL Ch9.
...
1. Build brands via PR, events, retail, CSR beyond advertising
...
- "how to build brands via pr, events, retail, csr beyond advertising"
...
- **Method applied:** `aaker-book-brand-building-beyond-advertising`
...
- The problem is outside the scope of BL Ch9.
