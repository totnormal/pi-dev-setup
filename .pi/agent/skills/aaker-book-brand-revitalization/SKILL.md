---
name: aaker-book-brand-revitalization
description: |
  Use when: Revitalize tired brands via new uses/markets/products. Trigger phrases: "brand revitalization", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Revitalizing the Brand ¹ This section was stimulated by Kenichi Ohmae, “Getting Back to Strategy,” Harvard Business Review, November-December 1988, pp."
>
> — Source: MBE Ch10

**Source mechanism:** Revitalize tired brands via new uses/markets/products This skill encodes the method from MBE Ch10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Revitalize tired brands via new uses/markets/products The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch10.
...
1. Revitalize tired brands via new uses/markets/products
...
- "how to revitalize tired brands via new uses/markets/products"
...
- **Method applied:** `aaker-book-brand-revitalization`
...
- The problem is outside the scope of MBE Ch10.
