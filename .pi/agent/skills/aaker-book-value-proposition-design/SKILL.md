---
name: aaker-book-value-proposition-design
description: |
  Use when: Design compelling, relevant, sustainable value propositions. Trigger phrases: "value proposition design", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
**Source mechanism:** Design compelling, relevant, sustainable value propositions This skill encodes the method from SMM Ch8 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Design compelling, relevant, sustainable value propositions The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch8.
...
1. Design compelling, relevant, sustainable value propositions
...
- "how to design compelling, relevant, sustainable value propositions"
...
- **Method applied:** `aaker-book-value-proposition-design`
...
- The problem is outside the scope of SMM Ch8.
