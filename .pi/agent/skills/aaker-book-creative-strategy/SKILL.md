---
name: aaker-book-creative-strategy
description: |
  Use when: Develop creative strategy and message approaches. Trigger phrases: "creative strategy", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Creative Approaches 389 Rational Creative Approaches 390 Emotional Creative Approaches 400 Using an Endorser 401 Distraction Effects 408 Summary 409 Discussion Questions 410 Notes 411"
>
> — Source: AM Ch12

**Source mechanism:** Develop creative strategy and message approaches This skill encodes the method from AM Ch12 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Develop creative strategy and message approaches The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch12.
...
1. Develop creative strategy and message approaches
...
- "how to develop creative strategy and message approaches"
...
- **Method applied:** `aaker-book-creative-strategy`
...
- The problem is outside the scope of AM Ch12.
