---
name: aaker-book-subcategory-definition
description: |
  Use when: Define and manage a new category/subcategory. Trigger phrases: "subcategory definition", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "FROM POSITIONING THE BRAND TO FRAMING THE SUBCATEGORY Frames are mental structures that shape the way we see the world."
>
> — Source: AoB Ch9

**Source mechanism:** Define and manage a new category/subcategory This skill encodes the method from BR Ch8 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Define and manage a new category/subcategory The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BR Ch8.
...
1. Define and manage a new category/subcategory
...
- "how to define and manage a new category/subcategory"
...
- **Method applied:** `aaker-book-subcategory-definition`
...
- The problem is outside the scope of BR Ch8.
