---
name: aaker-book-perceived-quality-leverage
description: |
  Use when: Diagnose and leverage perceived quality signals. Trigger phrases: "perceived quality leverage", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Perceived Quality Leverage

## R — Reading

> "Perceived Quality ¹ The Schlitz story comes in part from Susan Anderson, “Evaluation of Brand Equity” MBA Thesis, University of California at Berkeley, June 1989; Jacques Neher, “What Went Wrong?” Advertising Age, April 13, 1981, pp."
>
> — Source: MBE Ch4

**Source mechanism:** Diagnose and leverage perceived quality signals This skill encodes the method from MBE Ch4 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Diagnose and leverage perceived quality signals The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch4.
...
1. Diagnose and leverage perceived quality signals
...
- "how to diagnose and leverage perceived quality signals"
...
- **Method applied:** `aaker-book-perceived-quality-leverage`
...
- The problem is outside the scope of MBE Ch4.
