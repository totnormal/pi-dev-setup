---
name: aaker-book-brand-energizing
description: |
  Use when: Energize the brand via branded differentiators and subcategories. Trigger phrases: "brand energizing", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "discusses the lack of energy in brands and approaches that work to add energy."
>
> — Source: AoB Ch16

**Source mechanism:** Energize the brand via branded differentiators and subcategories This skill encodes the method from BPS Ch5, AoB Pr16 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Energize the brand via branded differentiators and subcategories The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BPS Ch5, AoB Pr16.
...
1. Energize the brand via branded differentiators and subcategories
...
- "how to energize the brand via branded differentiators and subcategories"
...
- **Method applied:** `aaker-book-brand-energizing`
...
- The problem is outside the scope of BPS Ch5, AoB Pr16.
