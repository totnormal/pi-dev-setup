---
name: aaker-book-advertising-response-model
description: |
  Use when: Model how advertising works (hierarchy of effects). Trigger phrases: "advertising response model", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Advertising can affect consumers in various ways, and the mechanism—or "route" of effect—sought in any particular situation needs to be clearly specified and understood before an ad can actually be created."
>
> — Source: AM Ch5

**Source mechanism:** Model how advertising works (hierarchy of effects) This skill encodes the method from AM Ch5 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Model how advertising works (hierarchy of effects) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch5.
...
1. Model how advertising works (hierarchy of effects)
...
- "how to model how advertising works (hierarchy of effects)"
...
- **Method applied:** `aaker-book-advertising-response-model`
...
- The problem is outside the scope of AM Ch5.
