---
name: aaker-book-brand-equity-model
description: |
  Use when: Apply the 4-dimension equity model (loyalty/awareness/quality/associations). Trigger phrases: "brand equity model", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "also sets the stage for the key points that will be made in this book about building strong brands."
>
> — Source: BSB Ch1

**Source mechanism:** Apply the 4-dimension equity model (loyalty/awareness/quality/associations) This skill encodes the method from MBE Ch1 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Apply the 4-dimension equity model (loyalty/awareness/quality/associations) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch1.
...
1. Apply the 4-dimension equity model (loyalty/awareness/quality/associations)
...
- "how to apply the 4-dimension equity model (loyalty/awareness/quality/associations)"
...
- **Method applied:** `aaker-book-brand-equity-model`
...
- The problem is outside the scope of MBE Ch1.
