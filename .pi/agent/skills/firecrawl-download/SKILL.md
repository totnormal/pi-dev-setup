...
description: "Firecrawl download. Maps the site first to discover pages, then scrapes each one into nested directories under `. Keywords: web scraping, crawling, data extraction, web automation, firecrawl download."
---
