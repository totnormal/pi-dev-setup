...
description: "Cache Components (Next.js 16+). Cache Components enable Partial Prerendering (PPR) - mix static, cached, and dynamic content in a single route. Keywords: next cache components."
---
