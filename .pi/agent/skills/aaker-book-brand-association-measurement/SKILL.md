---
name: aaker-book-brand-association-measurement
description: |
  Use when: Measure associations via free association, conjoint, mapping. Trigger phrases: "brand association measurement", "brand equity", Aaker equity. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "The Measurement of Brand Associations ¹ Drawn from Douglas Scott and Flaurel Englis, “Tracking Automotive Intentions and Imagery: A Case Study,” Journal of Advertising Research, February/March 1989, RC-13 to RC-20."
>
> — Source: MBE Ch6

**Source mechanism:** Measure associations via free association, conjoint, mapping This skill encodes the method from MBE Ch6, BSB Ch10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Measure associations via free association, conjoint, mapping The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MBE Ch6, BSB Ch10.
...
1. Measure associations via free association, conjoint, mapping
...
- "how to measure associations via free association, conjoint, mapping"
...
- **Method applied:** `aaker-book-brand-association-measurement`
...
- The problem is outside the scope of MBE Ch6, BSB Ch10.
