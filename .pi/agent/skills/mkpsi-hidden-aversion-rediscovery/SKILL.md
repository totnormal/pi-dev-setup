---
name: mkpsi-hidden-aversion-rediscovery
description: |
  Use when: Useful product has stale, cheap, medicinal, childish, gendered, low-status, or embarrassin
  g baggage. Trigger phrases: bad reputation,, stigma,, people resist it,, reposition,, rediscover,, n
  ot just rational objections.. NOT for: Do not hide material risks; do not relabel harmful products a
  s wholesome; avoid gender stereotypes unless critically audited and modernized.
source_book: |
...
source_chapter: |
  Ch. 13 “Cures for Our Hidden Aversions”
tags: [mkpsi-v2, research, p2]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-indirect-association-probe, mkpsi-rename-to-create-norm, mkpsi-residual-impression-audit]
disable-model-invocation: true
---

# Diagnose inherited aversions and reintroduce the product in a new symbolic context.

## R — Reading

> “Often our resistance seemed blindly unreasoning and could not be dislodged by standard dosages of persuasion. The doctors of commerce, using their diagnostic skills, were called upon to get to the roots of our resistance and prescribe corrective measures.”
>
> — Source: Ch. 13 “Cures for Our Hidden Aversions”

**Source mechanism:** - **Recognize:** A useful product carries stale, embarrassing, medicinal, cheap, feminine/masculine, childish, or low-status baggage.
- **Interpret:** The problem is the product’s inherited meaning, not its functional value.
- **Act:** List negative associations, isolate the strongest blockage, create a new symbolic context, and reintroduce the product as newly desirable.
...
- **Recognize:** A useful product carries stale, embarrassing, medicinal, cheap, feminine/masculine, childish, or low-status baggage.
- **Interpret:** The problem is the product’s inherited meaning, not its functional value.
- **Act:** List negative associations, isolate the strongest blockage, create a new symbolic context, and reintroduce the product as newly desirable.
...
### Case 1: Prunes were repositioned from old-maid/laxative imagery into a bright “wonder fr
- **Problem:** Prunes were repositioned from old-maid/laxative imagery into a bright “wonder fruit.”
...
### Case 2: Tea was moved from sickly, sissy, club-lady imagery toward “heft, hot and hearty
- **Problem:** Tea was moved from sickly, sissy, club-lady imagery toward “heft, hot and hearty” virility.
...
1. Useful product has stale, cheap, medicinal, childish, gendered, low-status, or embarrassing baggage.
...
- Sibling confusion risks: - Not crisis PR; it addresses chronic symbolic aversion.
- Not rebranding for novelty alone; it begins with a diagnosed psychological blockage.
- Not denial of real product flaws; fix functional issues first.

---

## E — Execution steps

1. **Apply the source method: - **Recognize:** A useful product carries stale, embarrassing, medicinal, cheap, feminine/masculine, childish, or low-status baggage. - **Interpret:** The problem is the product’s inherited meaning, not its functional value. - **Act:** List negative associations, isolate the strongest blockage, create a new symbolic context, and reintroduce the product as newly desirable.**
...
- **Selected mechanism:** `mkpsi-hidden-aversion-rediscovery` — Diagnose inherited aversions and reintroduce the product in a new symbolic context.
...
- Do not hide material risks; do not relabel harmful products as wholesome; avoid gender stereotypes unless critically audited and modernized.
...
- Not crisis PR; it addresses chronic symbolic aversion.
- Not rebranding for novelty alone; it begins with a diagnosed psychological blockage.
- Not denial of real product flaws; fix functional issues first.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-indirect-association-probe, /mkpsi-rename-to-create-norm, /mkpsi-residual-impression-audit
