---
name: aaker-book-upscale-value-markets
description: |
  Use when: Participate in upscale and value markets via brand strategy. Trigger phrases: "upscale value markets", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Upscale Value Markets

## R — Reading

> "In the case of John Deere lawn tractors, color and product design played a key role in separating a value product branded as “Scott from John Deere” from the classic, premium John Deere line."
>
> — Source: BPS Ch8

**Source mechanism:** Participate in upscale and value markets via brand strategy This skill encodes the method from BPS Ch8 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Participate in upscale and value markets via brand strategy The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BPS Ch8.
...
1. Participate in upscale and value markets via brand strategy
...
- "how to participate in upscale and value markets via brand strategy"
...
- **Method applied:** `aaker-book-upscale-value-markets`
...
- The problem is outside the scope of BPS Ch8.
