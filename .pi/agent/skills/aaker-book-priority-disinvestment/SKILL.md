---
name: aaker-book-priority-disinvestment
description: |
  Use when: Set priorities across SBUs and make disinvestment decisions. Trigger phrases: "priority disinvestment", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Priority Disinvestment

## R — Reading

> "Chapter 14 discusses setting priorities and the disinvestment option."
>
> — Source: SMM Ch14

**Source mechanism:** Set priorities across SBUs and make disinvestment decisions This skill encodes the method from SMM Ch14 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Set priorities across SBUs and make disinvestment decisions The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch14.
...
1. Set priorities across SBUs and make disinvestment decisions
...
- "how to set priorities across sbus and make disinvestment decisions"
...
- **Method applied:** `aaker-book-priority-disinvestment`
...
- The problem is outside the scope of SMM Ch14.
