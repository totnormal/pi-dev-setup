---
name: aaker-book-concept-evaluation
description: |
  Use when: Evaluate concepts on strategic fit, market, and execution. Trigger phrases: "concept evaluation", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Further, the offering concept that will drive the new category or subcategory needs to be generated and evaluated, the new category or subcategory needs to be actively managed, and barriers against competitors have to be created."
>
> — Source: BR Ch7

**Source mechanism:** Evaluate concepts on strategic fit, market, and execution This skill encodes the method from BR Ch7 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Evaluate concepts on strategic fit, market, and execution The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BR Ch7.
...
1. Evaluate concepts on strategic fit, market, and execution
...
- "how to evaluate concepts on strategic fit, market, and execution"
...
- **Method applied:** `aaker-book-concept-evaluation`
...
- The problem is outside the scope of BR Ch7.
