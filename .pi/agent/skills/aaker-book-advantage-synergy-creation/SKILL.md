---
name: aaker-book-advantage-synergy-creation
description: |
  Use when: Identify and create sustainable advantage and synergy. Trigger phrases: "advantage synergy creation", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
**Source mechanism:** Identify and create sustainable advantage and synergy This skill encodes the method from SMM Ch7 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Identify and create sustainable advantage and synergy The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch7.
...
1. Identify and create sustainable advantage and synergy
...
- "how to identify and create sustainable advantage and synergy"
...
- **Method applied:** `aaker-book-advantage-synergy-creation`
...
- The problem is outside the scope of SMM Ch7.
