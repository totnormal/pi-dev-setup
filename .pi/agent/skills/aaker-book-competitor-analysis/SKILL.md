---
name: aaker-book-competitor-analysis
description: |
  Use when: Identify, profile, and anticipate competitors. Trigger phrases: "competitor analysis", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "It is a challenging but exciting time, full of opportunities as well as threats."
>
> — Source: SMM Ch3

**Source mechanism:** Identify, profile, and anticipate competitors This skill encodes the method from SMM Ch3 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Identify, profile, and anticipate competitors The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch3.
...
1. Identify, profile, and anticipate competitors
...
- "how to identify, profile, and anticipate competitors"
...
- **Method applied:** `aaker-book-competitor-analysis`
...
- The problem is outside the scope of SMM Ch3.
