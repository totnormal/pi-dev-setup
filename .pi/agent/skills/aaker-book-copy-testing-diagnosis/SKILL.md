---
name: aaker-book-copy-testing-diagnosis
description: |
  Use when: Test and diagnose advertising copy. Trigger phrases: "copy testing diagnosis", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Advertising Copy Testing and Diagnosis 462 Copy-Testing Strategy 463 Diagnostic Copy Tests 476 Tracking Studies 480 Selecting Copy Tests: Validity and Reliability 482 Example of a Copy-Test Report 489 Summary 489 Discussion Questions 491 Notes 492 Appendix Notes on Four Copy-Test"
>
> — Source: AM Ch14

**Source mechanism:** Test and diagnose advertising copy This skill encodes the method from AM Ch14 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Test and diagnose advertising copy The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch14.
...
1. Test and diagnose advertising copy
...
- "how to test and diagnose advertising copy"
...
- **Method applied:** `aaker-book-copy-testing-diagnosis`
...
- The problem is outside the scope of AM Ch14.
