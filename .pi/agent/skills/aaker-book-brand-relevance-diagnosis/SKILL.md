---
name: aaker-book-brand-relevance-diagnosis
description: |
  Use when: Diagnose relevance position (is the brand's category declining?). Trigger phrases: "brand relevance diagnosis", "brand relevance", Aaker relevance. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Brand Relevance Diagnosis

## R — Reading

> "[] Contents Preface Chapter 1: Winning the Brand Relevance Battle The Japanese Beer Industry The U.S."
>
> — Source: BR Ch1, BR Ch2

**Source mechanism:** Diagnose relevance position (is the brand's category declining?) This skill encodes the method from BR Ch1-2 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Diagnose relevance position (is the brand's category declining?) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BR Ch1-2.
...
1. Diagnose relevance position (is the brand's category declining?)
...
- "how to diagnose relevance position (is the brand's category declining?)"
...
- **Method applied:** `aaker-book-brand-relevance-diagnosis`
...
- The problem is outside the scope of BR Ch1-2.
