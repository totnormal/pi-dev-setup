---
name: aaker-book-global-brand-leadership
description: |
  Use when: Coordinate brands globally (not global brands, global leadership). Trigger phrases: "global brand leadership", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "GLOBAL BRAND LEADERSHIP— NOT GLOBAL BRANDS 1."
>
> — Source: BL Ch10

**Source mechanism:** Coordinate brands globally (not global brands, global leadership) This skill encodes the method from BL Ch10 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Coordinate brands globally (not global brands, global leadership) The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BL Ch10.
...
1. Coordinate brands globally (not global brands, global leadership)
...
- "how to coordinate brands globally (not global brands, global leadership)"
...
- **Method applied:** `aaker-book-global-brand-leadership`
...
- The problem is outside the scope of BL Ch10.
