---
name: aaker-book-external-customer-analysis
description: |
  Use when: Analyze customers, segments, motivations, unmet needs. Trigger phrases: "external customer analysis", "brand strategy", Aaker strategy. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "‘Any manager seeking to develop a market driving strategy or any student wanting to learn about best-practice in strategic marketing needs to read this book.."
>
> — Source: SMM Ch2

**Source mechanism:** Analyze customers, segments, motivations, unmet needs This skill encodes the method from SMM Ch2 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Analyze customers, segments, motivations, unmet needs The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from SMM Ch2.
...
1. Analyze customers, segments, motivations, unmet needs
...
- "how to analyze customers, segments, motivations, unmet needs"
...
- **Method applied:** `aaker-book-external-customer-analysis`
...
- The problem is outside the scope of SMM Ch2.
