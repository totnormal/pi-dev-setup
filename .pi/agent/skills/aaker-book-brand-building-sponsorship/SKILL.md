---
name: aaker-book-brand-building-sponsorship
description: |
  Use when: Use sponsorship as a brand-building vehicle. Trigger phrases: "brand building sponsorship", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "BUILDING BRANDS— THE ROLE OF SPONSORSHIP 1."
>
> — Source: BL Ch7

**Source mechanism:** Use sponsorship as a brand-building vehicle This skill encodes the method from BL Ch7 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Use sponsorship as a brand-building vehicle The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BL Ch7.
...
1. Use sponsorship as a brand-building vehicle
...
- "how to use sponsorship as a brand-building vehicle"
...
- **Method applied:** `aaker-book-brand-building-sponsorship`
...
- The problem is outside the scope of BL Ch7.
