---
name: aaker-book-attention-comprehension-design
description: |
  Use when: Design ads for attention, comprehension, and retention. Trigger phrases: "attention comprehension design", "brand advertising", Aaker advertising. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
# Attention Comprehension Design

## R — Reading

> "Attention and Comprehension 219 Attention 221 From Attention to Recall 235 Attention versus Comprehension 236 Interpretation and Comprehension 237 Summary 243 Discussion Questions 244 Notes 245"
>
> — Source: AM Ch7

**Source mechanism:** Design ads for attention, comprehension, and retention This skill encodes the method from AM Ch7 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Design ads for attention, comprehension, and retention The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from AM Ch7.
...
1. Design ads for attention, comprehension, and retention
...
- "how to design ads for attention, comprehension, and retention"
...
- **Method applied:** `aaker-book-attention-comprehension-design`
...
- The problem is outside the scope of AM Ch7.
