---
name: aaker-book-sampling-design
description: |
  Use when: Design sampling plans and determine sample size. Trigger phrases: "sampling design", "brand research", Aaker research. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "Sampling is the process of estimating a population parameter by contacting only a subset of the population. Sampling is adopted because of the limitations of time and money. In some cases a census may not be possible and sampling may be the only alternative."
>
> — Source: MR Ch14

**Source mechanism:** Design sampling plans and determine sample size This skill encodes the method from MR Ch14 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Design sampling plans and determine sample size The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MR Ch14.
...
1. Design sampling plans and determine sample size
...
- "how to design sampling plans and determine sample size"
...
- **Method applied:** `aaker-book-sampling-design`
...
- The problem is outside the scope of MR Ch14.
