---
name: aaker-book-brand-identity-elaboration
description: |
  Use when: Elaborate identity: value proposition, functional/emotional/social benefits, credibility. Trigger phrases: "brand identity elaboration", "brand architecture", Aaker architecture. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "BRAND IDENTITY— THE CORNERSTONE OF BRAND STRATEGY 1."
>
> — Source: BL Ch2, BL Ch3

**Source mechanism:** Elaborate identity: value proposition, functional/emotional/social benefits, credibility This skill encodes the method from BL Ch2-3 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Elaborate identity: value proposition, functional/emotional/social benefits, credibility The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from BL Ch2-3.
...
1. Elaborate identity: value proposition, functional/emotional/social benefits, credibility
...
- "how to elaborate identity: value proposition, functional/emotional/social benefits, credibility"
...
- **Method applied:** `aaker-book-brand-identity-elaboration`
...
- The problem is outside the scope of BL Ch2-3.
