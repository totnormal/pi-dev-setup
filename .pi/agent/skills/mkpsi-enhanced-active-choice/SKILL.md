---
name: mkpsi-enhanced-active-choice
description: |
  Use when: Passive opt-in/default underperforms because users do not own the choice. Trigger phrases:
   choose one, I will / I will not, even if it means, miss out on, active choice.. NOT for: Loss state
  ment must be accurate and proportionate. Avoid coercive wording for high-stakes or ambiguous choices
  .
source_book: |
...
source_chapter: |
  Chapter 17, “make defaults more effective.”
tags: [mkpsi-v2, choice, p2]
related_skills: [mkpsi-orchestrator, mkpsi-output-verifier, mkpsi-manipulation-ethics-gate, mkpsi-flip-default-to-beneficial-opt-out, mkpsi-gratuitous-choice, mkpsi-reframe-equivalent-options]
disable-model-invocation: true
---

# Replace passive opt-in with an explicit choice enhanced by accurate loss clarity.

## R — Reading

> “First take the small step to consider the two choices that you want your audience to actively choose from. Then take the additional small step to enhance your preferred choice by pointing out what could be lost if it is not selected.”
>
> — Source: Chapter 17, “make defaults more effective.”

**Source mechanism:** - **Recognize:** A default or opt-in underperforms because people stay passive or fail to own the choice.
- **Intervene:** Present two explicit options: “I will…” vs “I will not… even if it means losing/missing…”
- **Assess:** Compare opt-in, active choice, and enhanced active choice conversion.
...
- **Recognize:** A default or opt-in underperforms because people stay passive or fail to own the choice.
- **Intervene:** Present two explicit options: “I will…” vs “I will not… even if it means losing/missing…”
- **Assess:** Compare opt-in, active choice, and enhanced active choice conversion.
...
### Case 1: **Recognize
- **Problem:** **Recognize:** A default or opt-in underperforms because people stay passive or fail to own the choice.
...
### Case 2: **Intervene
- **Problem:** **Intervene:** Present two explicit options: “I will…” vs “I will not… even if it means losing/missing…”
...
1. Passive opt-in/default underperforms because users do not own the choice.
...
- Sibling confusion risks: - Not a default-with-opt-out; no option is preselected.
- Not scarcity; the loss is consequence clarity, not artificial limited supply.

---

## E — Execution steps

1. **Apply the source method: - **Recognize:** A default or opt-in underperforms because people stay passive or fail to own the choice. - **Intervene:** Present two explicit options: “I will…” vs “I will not… even if it means losing/missing…” - **Assess:** Compare opt-in, active choice, and enhanced active choice conversion.**
...
- **Selected mechanism:** `mkpsi-enhanced-active-choice` — Replace passive opt-in with an explicit choice enhanced by accurate loss clarity.
...
- Loss statement must be accurate and proportionate. Avoid coercive wording for high-stakes or ambiguous choices.
...
- Not a default-with-opt-out; no option is preselected.
- Not scarcity; the loss is consequence clarity, not artificial limited supply.
...
- composes-with: /mkpsi-orchestrator, /mkpsi-output-verifier, /mkpsi-manipulation-ethics-gate, /mkpsi-flip-default-to-beneficial-opt-out, /mkpsi-gratuitous-choice, /mkpsi-reframe-equivalent-options
