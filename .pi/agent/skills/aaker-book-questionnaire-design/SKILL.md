---
name: aaker-book-questionnaire-design
description: |
  Use when: Design valid, reliable questionnaires. Trigger phrases: "questionnaire design", "brand research", Aaker research. NOT for: chapter summaries or general marketing advice without source grounding.
source_book: |
...
> "New cases and study questions have been added."
>
> — Source: MR Ch12

**Source mechanism:** Design valid, reliable questionnaires This skill encodes the method from MR Ch12 into an actionable procedure.

---

## I — Methodology skeleton (Interpretation)

Design valid, reliable questionnaires The source develops this as a systematic approach with specific steps, criteria, and decision points.
...
- **Result/evidence:** Corroborating case from MR Ch12.
...
1. Design valid, reliable questionnaires
...
- "how to design valid, reliable questionnaires"
...
- **Method applied:** `aaker-book-questionnaire-design`
...
- The problem is outside the scope of MR Ch12.
